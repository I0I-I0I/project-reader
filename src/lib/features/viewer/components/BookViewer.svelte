<script lang="ts">
    import PDFDocument, { Page } from "$lib/core/pdf/pdf"
    ...
    import CanvasPane from "$lib/features/viewer/components/CanvasPane.svelte"
    import ViewerFooter from "$lib/features/viewer/components/ViewerFooter.svelte"
