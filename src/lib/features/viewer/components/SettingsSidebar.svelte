<script lang="ts">
    ...
    import SplitPagesIcon from "$lib/core/components/icons/SplitPagesIcon.svelte"
    import ScrollPagesIcon from "$lib/core/components/icons/ScrollPagesIcon.svelte"
    import SunIcon from "$lib/core/components/icons/SunIcon.svelte"
    ...
    import Toggle from "$lib/core/components/ui/Toggle.svelte"
    import { CONSTANTS, settingsStore, type Theme } from "$lib/core/stores/settingsStore.svelte"
