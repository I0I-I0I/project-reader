<script lang="ts">
    ...
    import { vfsStore, usePreviewUrl } from "$lib/core/vfs/vfsStore.svelte"
    import type { VFSNode, FileNode } from "$lib/core/vfs/vfsStore.types"
    ...
    import MoreVerticalIcon from "$lib/core/components/icons/MoreVerticalIcon.svelte"
